...
// 本模块**不写死任何核心名、匹配式或台词**：核心名 / 标签 / 说话人 / 参数枚举 / 范例
// 全部来自用户粘进 ⑤ 页文本框的核心全文（AI 解析 + 脚本四项校验），匹配式再据此当场生成；
// 换一个核心、换一套语言格式，产出的查找表达式与替换体随之改变。
// ============================================================================
